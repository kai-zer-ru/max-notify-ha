...
- Диапазон интервала опроса тоже с сервера: на шаге интервала это указано в подсказке.
- В мастере и в настройках убраны лишние тексты: на каждом экране только то, что к нему относится. Интервал опроса — на шаге интервала, автоотключение — на своём шаге, формат и режим — без чужих лимитов.
