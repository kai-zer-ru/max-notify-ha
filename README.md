...
3. Для Long Polling задайте **wait** (5–60 с) и **limit** (сколько событий за раз); срок автоотключения задаёт сервер. Правило переключения на «только отправка» — в [блоке про сервис](#сервис-notifya161ru).
