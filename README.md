...
- В **веб-клиенте** и **десктопном приложении** Max уведомления о новых сообщениях **приходят**.
- В **мобильном приложении**: в **личном чате с ботом** уведомления **приходят**; в **группах и каналах** push на телефон **может не приходить**, хотя сообщение в ленте чата отображается.
