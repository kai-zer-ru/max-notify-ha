"""Тесты модуля helpers."""

from __future__ import annotations

import pytest

from custom_components.max_notify.api import normalize_access_token
...
class TestNormalizeServiceButtons:
    """Тесты normalize_service_buttons."""
...
class TestNormalizeCommands:
    """Тесты normalize_commands (legacy)."""
